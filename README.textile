h1. Rails 3.2 Subdomains and Devise

This is a detailed Rails subdomains tutorial showing how to create an example Rails 3.2 application with subdomains and authentication using Devise. The "Devise":http://github.com/plataformatec/devise gem gives you ready-made authentication and user management. MongoDB is used as a datastore with the "Mongoid":http://mongoid.org/  gem for quick development without schemas or migrations.
